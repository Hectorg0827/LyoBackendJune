...
class StudyMessage(Base):
    ...
    user_sentiment = Column(String(50), nullable=True)  # positive, negative, neutral, confused
    
    # Quality metrics
    helpfulness_rating = Column(Integer, nullable=True)  # 1-5 scale (user feedback)
    clarity_score = Column(Float, nullable=True)  # AI-assessed clarity (0-1)
