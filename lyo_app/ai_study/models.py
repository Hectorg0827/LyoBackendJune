...
class StudySession(Base):
    ...
    quiz_sessions = relationship("QuizSession", back_populates="session", cascade="all, delete-orphan")
...
class QuizSession(Base):
    """Represents a quiz session within a study session"""
    ...
    # Relationships
    session = relationship("StudySession", back_populates="quiz_sessions")
    quiz = relationship("GeneratedQuiz")
