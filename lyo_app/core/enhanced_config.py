...
class EnhancedSettings(BaseSettings):
    ...
    GEMINI_MODEL_DEFAULT: str = Field("gemini-3.1-pro-preview-customtools", description="Default Gemini model")
    GEMINI_MODEL_VISION: str = Field("gemini-pro-vision", description="Gemini vision model")
    GEMINI_MODEL_FLASH: str = Field("gemini-3.1-pro-preview-customtools", description="Gemini flash model")
